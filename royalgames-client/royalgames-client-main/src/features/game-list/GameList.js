    ...
    <div className="GameList">
      <div className={`list ${!loggedIn ? 'd-none' : ''}`}>
        <div className="game" style={{position: 'relative'}}>
          <img className="logo" src={egyptianTreasuresLogo} alt="Egyptian Treasures Slots Logo - Royal Games Social Casino"/>
        ...
        <div className="game">
          <img className="logo" src={rockClimberLogo} alt="Rock Climber Slots Logo - Royal Games Social Casino"/>
